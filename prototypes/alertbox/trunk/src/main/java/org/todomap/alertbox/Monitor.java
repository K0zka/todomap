...
public class Monitor {
	...
	final BlockingQueue<Runnable> runnables = new ArrayBlockingQueue<Runnable>(1024);
	final ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(1, 10, 30, TimeUnit.SECONDS, runnables);
	...
	final public void updateMonitorStatus(final Monitorable monitorable, final StatusDescription desc) {
